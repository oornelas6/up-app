...
const getStyles = (theme) => ({
  ...
  title: { fontSize: 42, fontWeight: '900', color: theme.text, letterSpacing: -1 },
  empty: { fontSize: 16, color: theme.textSecondary, marginTop: 40, textAlign: 'center' },
  sectionLabel: { fontSize: 12, fontWeight: '700', letterSpacing: 3, color: theme.textTertiary, marginBottom: 12, marginTop: 24 },
  ...
  overviewVal: { fontSize: 36, fontWeight: '900', color: theme.text, letterSpacing: -1 },
  overviewLbl: { fontSize: 11, color: theme.textTertiary, fontWeight: '700', letterSpacing: 2, marginTop: 4 },
  ...
  muscleName: { fontSize: 15, fontWeight: '600', color: theme.text, width: 80 },
  muscleBarContainer: { flex: 1, height: 6, borderRadius: 3, marginHorizontal: 12, overflow: 'hidden' },
  muscleBar: { height: '100%', borderRadius: 3 },
  muscleCount: { fontSize: 14, color: theme.textSecondary, fontWeight: '600', width: 24, textAlign: 'right' },
  ...
  exerciseName: { flex: 1, fontSize: 16, fontWeight: '600', color: theme.text },
  exerciseVolume: { fontSize: 15, fontWeight: '700', color: 'rgba(157,78,221,0.8)' },
  // Modal
